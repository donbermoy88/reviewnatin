      ...
      'basic-operations-sub': {
        ...
        questions: [
          ...
          },
          {
            ...
            correct: 'c', diff: 1,
            exp_en: 'Multiply daily pay by the number of days: ₱480 × 5 = ₱2,400, so the worker earns ₱2,400 in 5 days.',
            exp_fil: 'I-multiply ang arawang kita sa bilang ng araw: ₱480 × 5 = ₱2,400, kaya ₱2,400 ang kinita sa 5 araw.',
          },
          {
          ...
          },
          {
            ...
            correct: 'c', diff: 1,
            exp_en: 'A squared number means the number multiplied by itself. Therefore, 7² = 7 × 7 = 49.',
            exp_fil: 'Ang squared number ay bilang na minultiply sa sarili nito. Kaya 7² = 7 × 7 = 49.',
          },
          {
            stem: 'A bag of rice costs ₱55. How much do 6 bags cost?',
            choices: [{ id:'a', text:'₱300' }, { id:'b', text:'₱320' }, { id:'c', text:'₱330' }, { id:'d', text:'₱350' }],
            correct: 'c', diff: 1,
            exp_en: 'Each bag costs ₱55. For 6 bags, multiply 55 by 6: ₱55 × 6 = ₱330.',
            exp_fil: 'Bawat sako ay ₱55. Para sa 6 na sako, i-multiply ang 55 sa 6: ₱55 × 6 = ₱330.',
          },
          {
            stem: 'Divide 360 by 12.',
            choices: [{ id:'a', text:'28' }, { id:'b', text:'30' }, { id:'c', text:'32' }, { id:'d', text:'36' }],
            correct: 'b', diff: 1,
            exp_en: 'Divide 360 into 12 equal groups. Since 12 × 30 = 360, 360 ÷ 12 = 30.',
            exp_fil: 'Hatiin ang 360 sa 12 pantay na grupo. Dahil 12 × 30 = 360, 360 ÷ 12 = 30.',
          },
          {
