...
SOURCE_DIR = Path("/Users/lyndon/All reviewers/-LET REVIEWER 2026/C. MAJOR SUBJECTS/J. SPECIAL NEEDS EDUCATION")
OUT_DIR = ROOT / "output/pdf"
BASE = "let_special_needs_education_qa_2026_extracted_questions"
...
def extract_pdf(path, start_no):
    ...
    for original_no, block in split_items(question_text):
        ...
        row = {
            ...
            "Subject Area": "Special Needs Education",
            ...
            "Status": "",
            "Notes": "LET Secondary Special Needs Education Q&A. Correct answer sourced from PDF answer key.",
        }
...
def write_outputs(rows, summary):
    ...
    lines = ["# LET Special Needs Education Q&A 2026 Extraction", ""]
    for row in rows:
