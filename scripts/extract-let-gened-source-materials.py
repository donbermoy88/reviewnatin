...
def slug_context(path, text):
    ...
    if re.search(r"\bmajor subjects?\b|\barea of specialization\b", path_source):
        if re.search(r"\b(j\.\s*special needs education|special needs education|special needs ed|sped|special education|inclusive education)\b", path_source):
            return "major", "special-needs-education"
...
def main():
    ...
    for path in files:
        ...
        elif subject_slug == "major" and topic_slug == "tle":
        ...
        elif subject_slug == "major" and topic_slug == "special-needs-education":
            title_scope = "Special Needs Education Major"
        else:
