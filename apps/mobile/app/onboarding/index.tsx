...
function createOnboardingStyles(theme: AppTheme) {
  ...
  examName: { ...type.subtitle, color: colors.text, fontSize: 15 },
  examSub: { fontFamily: fonts.bodyMedium, fontSize: 13, lineHeight: 18, color: colors.textMuted, marginTop: 3 },
  radio: {
    width: 24,
    height: 24,
    borderRadius: 12,
  ...
  goalTileLabel: { ...type.subtitle, color: colors.text, fontSize: 14, marginTop: 4 },
