...
function createStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    featureTextDark: { fontFamily: fonts.bodyMedium, fontSize: 15, lineHeight: 22, color: 'rgba(255,255,255,0.92)', flex: 1 },
    ...
    bigCtaText: { fontFamily: fonts.display, fontSize: 16, color: colors.primaryDark },
    ctaLinkText: { fontFamily: fonts.bodySemiBold, fontSize: 14, color: 'rgba(255,255,255,0.65)' },
    restoreHint: {
      fontFamily: fonts.bodyMedium,
      fontSize: 11,
      color: 'rgba(255,255,255,0.55)',
