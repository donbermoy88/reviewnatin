...
function PracticeScreenContent() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      const [areas, count, analytics] = await Promise.all([
      ...
      <View style={styles.root}>
        <ScrollView contentContainerStyle={tabScrollPaddingWithFooter(insets)}>
          <LoadingState
            ...
            description="Fetching subjects for your exam."
            cards={4}
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.body}>
          {!isPremium(examTypeId) ? <AdBanner onPress={() => router.push('/subscribe')} /> : null}
