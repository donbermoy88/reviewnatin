...
export function createDashboardStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    quickActionText: { fontFamily: fonts.bodyBold, fontSize: 11, color: colors.textMuted },
    goalCard: {
      borderRadius: radii.xl,
      padding: spacing.lg,
      flexDirection: 'row',
...
export function createAnalyticsStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    summaryTitle: { fontFamily: fonts.bodyBold, fontSize: 15, color: colors.text },
    summarySub: { fontFamily: fonts.bodyMedium, fontSize: 12, color: colors.textMuted, marginTop: 4 },
    sectionLbl: {
      fontFamily: fonts.bodyBold,
      fontSize: 11,
      color: colors.textMuted,
    ...
    subjectHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm },
    subjectName: { fontFamily: fonts.bodyBold, fontSize: 15, color: colors.text },
    subjectPct: { fontFamily: fonts.display, fontSize: 18, color: colors.primary },
    topicRow: { marginTop: spacing.sm },
    topicMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
    topicName: { fontFamily: fonts.bodySemiBold, fontSize: 13, color: colors.text, flex: 1, marginRight: spacing.sm },
    topicPct: { fontFamily: fonts.bodyBold, fontSize: 12, color: colors.textMuted },
    ...
    weakChipText: { fontFamily: fonts.bodyBold, fontSize: 11, color: colors.error },
  });
}
