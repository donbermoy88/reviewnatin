...
export function createSettingsStyles(theme: AppTheme) {
  const { colors, type, fonts, spacing, radii, shadows } = theme;
  return StyleSheet.create({
    ...
    backBtnPressed: { opacity: 0.78, transform: [{ scale: 0.98 }] },
    headerTitle: { fontFamily: fonts.display, fontSize: 27, color: '#fff', lineHeight: 33, letterSpacing: 0 },
    headerSub: { fontFamily: fonts.bodySemiBold, fontSize: 13, color: 'rgba(255,255,255,0.74)', marginTop: spacing.sm, lineHeight: 19 },
    ...
    toastText: { fontFamily: fonts.bodyMedium, fontSize: 14, color: colors.text, lineHeight: 20 },
    toastAction: { alignSelf: 'flex-start', marginTop: spacing.xs },
    toastActionText: { fontFamily: fonts.bodyBold, fontSize: 12, color: colors.primary },
    userCard: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: spacing.md,
    ...
    row: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: spacing.md, padding: spacing.md },
    ...
    localeSwitch: { flexDirection: 'row', gap: 6 },
    localeOption: {
      minHeight: 36,
      minWidth: 42,
      alignItems: 'center',
    ...
    localeOptionActive: { backgroundColor: colors.primary, borderColor: colors.primary },
    localeOptionText: { fontFamily: fonts.bodyBold, fontSize: 12, color: colors.textMuted },
    localeOptionTextActive: { color: '#fff' },
    disclaimerBox: {
      flexDirection: 'row',
      gap: spacing.sm,
...
export function createDashboardStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    heroEmptyRingText: { fontFamily: fonts.display, fontSize: 24, color: '#fff' },
    heroFocusLabel: {
      fontFamily: fonts.bodyBold,
      fontSize: 12,
      color: 'rgba(255,255,255,0.72)',
    ...
    heroMetricRail: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.md },
    statPill: {
      flex: 1,
      flexDirection: 'row',
      alignItems: 'center',
    ...
    sectionPad: { paddingHorizontal: spacing.lg, paddingTop: spacing.lg },
    continueCard: {
      backgroundColor: colors.surface,
      borderRadius: radii.xl,
      padding: spacing.lg,
    ...
    pasapathMeta: { fontFamily: fonts.bodyMedium, fontSize: 13, color: colors.textMuted, marginTop: 4, marginBottom: spacing.md },
    ...
    planSummaryValue: { fontFamily: fonts.display, fontSize: 18, color: colors.primary, letterSpacing: 0 },
    planSummaryLabel: {
      fontFamily: fonts.bodyBold,
      fontSize: 10,
    ...
    quickActionText: { fontFamily: fonts.bodyBold, fontSize: 14, color: colors.text, letterSpacing: 0 },
    quickActionSub: { fontFamily: fonts.bodySemiBold, fontSize: 11, color: colors.textMuted, marginTop: 3 },
    goalLbl: {
      fontFamily: fonts.bodyBold,
      fontSize: 11,
    ...
    goalHint: { fontFamily: fonts.bodySemiBold, fontSize: 12, color: colors.textMuted, marginTop: spacing.md, lineHeight: 17 },
    ...
    progressPercentText: { fontFamily: fonts.display, fontSize: 16, color: colors.primary, letterSpacing: 0 },
    ...
    snapshotMetricValue: { fontFamily: fonts.display, fontSize: 18, color: colors.text, letterSpacing: 0 },
    snapshotMetricLabel: {
      fontFamily: fonts.bodyBold,
      fontSize: 10,
      color: colors.textMuted,
    ...
    sectionTitle: { fontFamily: fonts.bodyBold, fontSize: 17, color: colors.text, letterSpacing: 0 },
    sectionSub: { fontFamily: fonts.bodySemiBold, fontSize: 12, color: colors.textMuted, marginTop: 3, lineHeight: 17 },
    quickRow: {
      flexDirection: 'row',
      alignItems: 'flex-start',
      gap: spacing.md,
    ...
    quickIcon: { width: 48, height: 48, borderRadius: radii.lg, alignItems: 'center', justifyContent: 'center' },
    ...
    updatesChipText: { fontFamily: fonts.bodyBold, fontSize: 14, color: colors.text },
    ...
    guestBannerTitle: { fontFamily: fonts.bodyBold, fontSize: 15, color: colors.text },
    guestBannerSub: { fontFamily: fonts.bodyMedium, fontSize: 13, color: colors.textMuted, marginTop: 4, lineHeight: 18 },
    lowerSection: { marginTop: spacing.lg },
  });
}
...
export function createStudyStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    headerNav: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.md, flexWrap: 'wrap' },
    headerBadge: {
      borderRadius: radii.full,
      backgroundColor: 'rgba(255,255,255,0.15)',
      borderWidth: 1,
    ...
    headerSub: { fontFamily: fonts.bodyMedium, fontSize: 13, color: 'rgba(255,255,255,0.78)', marginTop: spacing.sm, lineHeight: 19 },
    headerStats: {
      flexDirection: 'row',
      gap: spacing.sm,
      marginTop: spacing.lg,
    ...
    headerStatValue: { fontFamily: fonts.display, fontSize: 20, color: '#fff', letterSpacing: 0 },
    headerStatLabel: {
      fontFamily: fonts.bodyBold,
      fontSize: 10,
    ...
    contentGateWrap: { paddingHorizontal: spacing.lg, marginTop: spacing.md },
    tabs: {
      flexDirection: 'row',
      gap: spacing.sm,
      paddingHorizontal: spacing.lg,
    ...
    subjectIcon: { width: 48, height: 48, borderRadius: radii.lg, alignItems: 'center', justifyContent: 'center' },
    subjectName: { fontFamily: fonts.bodyBold, fontSize: 16, color: colors.text, letterSpacing: 0, lineHeight: 21 },
    subjectMeta: { fontFamily: fonts.bodySemiBold, fontSize: 12, color: colors.textMuted, marginTop: 3, lineHeight: 17 },
    subjectStatsRow: {
      flexDirection: 'row',
      flexWrap: 'wrap',
      gap: spacing.xs,
    ...
    filterChipText: { fontFamily: fonts.bodyBold, fontSize: 13, color: colors.textMuted },
...
export function createProfileStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    profileBadgeText: { fontFamily: fonts.bodyBold, fontSize: 11, color: '#fff', letterSpacing: 0.4, textTransform: 'uppercase' },
    headerTitle: { fontFamily: fonts.display, fontSize: 27, color: '#fff', lineHeight: 33, letterSpacing: 0 },
    settingsBtn: {
      width: 44,
      height: 44,
    ...
    profileSummaryTitle: { fontFamily: fonts.display, fontSize: 20, color: '#fff', marginTop: 3, letterSpacing: 0 },
    profileSummarySub: { fontFamily: fonts.bodySemiBold, fontSize: 12, color: 'rgba(255,255,255,0.74)', marginTop: 4, lineHeight: 17 },
    statsCard: {
    ...
    sectionTitle: { fontFamily: fonts.bodyBold, fontSize: 17, color: colors.text, letterSpacing: 0, marginBottom: spacing.sm },
    weeklyCard: {
      borderRadius: radii.xl,
      padding: spacing.lg,
      marginTop: spacing.sm,
